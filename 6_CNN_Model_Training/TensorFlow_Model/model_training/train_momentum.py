...
flags.DEFINE_integer('save_interval_secs', 900,
...
flags.DEFINE_enum('optimizer', 'adagrad', ['momentum', 'adam'],
...
flags.DEFINE_float('end_learning_rate', 0.0007,
...
flags.DEFINE_integer('training_number_of_steps', 8000,
                     'The number of steps used for training')

flags.DEFINE_float('momentum', 0.9, 'The momentum value to use')

# Adam optimizer flags
flags.DEFINE_float('adam_learning_rate', 0.00001,
...
flags.DEFINE_float('min_scale_factor', 1,#0.5,
                   'Mininum scale factor for data augmentation.')

flags.DEFINE_float('max_scale_factor', 1,#1.5,
                   'Maximum scale factor for data augmentation.')

flags.DEFINE_float('scale_factor_step_size', 1,#0.10,
    ...
    with tf.device(config.optimizer_device()):
      ...
      if FLAGS.optimizer == 'momentum':
        ...
        optimizer = tf.train.AdagradOptimizer(
            learning_rate=FLAGS.adagrad_learning_rate)
      else:
