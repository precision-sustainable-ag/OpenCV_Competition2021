...
tf.app.flags.DEFINE_string(
    'dataset4_train_image_folder',
    'opencv/dataset4/Images',
    'Folder containing trainng images')
tf.app.flags.DEFINE_string(
    'dataset4_train_image_label_folder',
    'opencv/dataset4/labels',
    'Folder containing annotations for trainng images')
    
    
tf.app.flags.DEFINE_string(
    'output_dir', 'opencv/tfrecord',
...
def main(unused_argv):
  ...
  _convert_dataset('dataset4_train', FLAGS.dataset4_train_image_folder, FLAGS.dataset4_train_image_label_folder)
