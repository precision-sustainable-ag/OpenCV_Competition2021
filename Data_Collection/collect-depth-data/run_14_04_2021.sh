...
-n 30 -d -dr r -c use_calibration -f 3 -mc /home/pi/mono_calib.npz -rc /home/pi/RGB_calib.npz

python3 02_save_rgb_depth_data.py -sp /home/pi/collected_data/week1/$number/stop1/$(date +"%Y_%m_%d_%H_%M_%S") \
-n 30 -d -dr d -c use_calibration -f 3 -mc /home/pi/mono_calib.npz -rc /home/pi/RGB_calib.npz
