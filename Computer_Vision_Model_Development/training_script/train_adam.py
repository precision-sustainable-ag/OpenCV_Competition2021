...
flags.DEFINE_float('end_learning_rate', 0.00001,
...
flags.DEFINE_float('adam_learning_rate', 0.000001,
...
flags.DEFINE_float('weight_decay', 0.000004,
...
flags.DEFINE_float('min_scale_factor', 0.4,
                   'Mininum scale factor for data augmentation.')

flags.DEFINE_float('max_scale_factor', 0.6,
                   'Maximum scale factor for data augmentation.')

flags.DEFINE_float('scale_factor_step_size', 0.05,
...
flags.DEFINE_integer(
    'hard_example_mining_step', 15000,
